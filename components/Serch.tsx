...
<<<<<<< HEAD
       ...
       <form action="serch">
      <input
        className="input_serch  w-[465px]  h-[46px] rounded-[23px] centarItemen pl-4"
        type="text"
