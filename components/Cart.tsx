...
const Cart = () => {
  const db = [
    {
      namePublic: 'Concierto de Lady Gaga',
      descripcionPublic:
      ...
      imgPublic: '../Rectangle_3.png',
      votos: '90’800’756',
    },
    {
      namePublic: 'Tienda de ropa femenina Zara',
      descripcionPublic: 'Tienda de Ropa',
      imgPublic: '../Rectangle_31.png',
      votos: '90’800’756',
    },
    {
      namePublic: 'Concierto de BTS',
      descripcionPublic: 'Grupo musical coreano',
      imgPublic: '../Rectangle_32.png',
      votos: '90’800’756',
    },
  ];

  const userName = db.map((user) => user.namePublic);
  const userDescripcio = db.map((users) => users.descripcionPublic);
  const userImg = db.map((user) => user.imgPublic);
      ...
      >
        <SwiperSlide>
          <div className="w-72  color_cart">
            <picture>
              <img src={userImg[2]} alt="" />
            </picture>

            <Likes />
            <article className="relative bottom-16">
              <h1 className="h1_cart padig-left"> {userName[2]} </h1>
              <p className="padig-left">{userDescripcio[2]}</p>
              <a href="bts.com" className="text-cyan-400 padig-left">
                bts.com
              </a>
              <svg
                width="17"
              ...
              <p className=" relative left-6 bottom-4"> {userVotos[0]} </p>
            </article>
          </div>
        </SwiperSlide>
        <SwiperSlide>
          <div className="w-72  color_cart">
            ...
            <article className="relative bottom-16">
              ...
              <p className="padig-left">{userDescripcio[0]}</p>
              <a href="ladygaga.com" className="text-cyan-400 padig-left"></a>
              <svg
                width="17"
                height="17"
                viewBox="0 0 17 17"
        ...
        <SwiperSlide>
          <div className="w-72  color_cart">
            <picture>
              <img src={userImg[1]} alt="" />
            </picture>

            <Likes />
            <article className="relative bottom-16">
              <h1 className="h1_cart padig-left"> {userName[1]} </h1>
              <p className="padig-left">{userDescripcio[1]}</p>
